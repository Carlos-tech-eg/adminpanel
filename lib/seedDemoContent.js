...
async function seedDemoContentIfEmpty() {
  const [n, v, r, a] = await Promise.all([
  ...
  await ConsularRegistration.insertMany([
    {
      fullName: "Ana Consular",
      email: "ana.consular@example.com",
  ...
  return { seeded: true, message: "Demo news, visas, registrations & appointments inserted" };
}
